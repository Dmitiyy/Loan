...
/* harmony import */ var _modules_download__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/download */ "./src/js/modules/download.js");
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  new _modules_mask__WEBPACK_IMPORTED_MODULE_5__["default"]('.inp-phone').init();
  new _modules_accordion__WEBPACK_IMPORTED_MODULE_6__["default"]('.plus__content', '.msg').init();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Accor; });
...
/*#__PURE__*/
function () {
  function Accor(trigger, content) {
  ...
  _createClass(Accor, [{
    ...
    value: function init() {
      ...
      this.hide();
      this.btn.forEach(function (item, i) {
        item.addEventListener('click', function () {
          if (_this.content[i].style.opacity == '1') {
            _this.hide();
          } else {
            _this.content[i].style.marginTop = '20px';
            _this.content[i].style.opacity = '1';
            _this.content[i].style.height = _this.content[i].scrollHeight + 'px';
          }
        });
      });
    }
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTriggers",
    value: function bindTriggers(selector, count, item) {
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function clearInputs() {
      document.querySelectorAll('.inp-post').forEach(function (item) {
        item.value = '';
      });
    }
  }, {
    ...
    value: function init() {
      ...
      this.form.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          div.textContent = _this.loading;

          _this.postData(_this.path, formData).then(function (res) {
            console.log(res);
            div.textContent = _this.success;
          }).catch(function (res) {
            console.log(res);
            div.textContent = _this.failure;
          }).finally(function () {
            _this.clearInputs();
          ...
          div.style.cssText = "\n                    color:black;\n                    font-weight:bold;\n                    font-size:20px;\n                    margin-top:20px;\n                ";
          document.querySelectorAll('.inp-post').forEach(function (inp) {
            if (inp.value == '') {
              writeAns = 'undef';
            } else {
              item.append(div);
...
function () {
  ...
  _createClass(Mask, [{
    ...
    value: function init() {
      try {
        var phoneMask = IMask(this.selector, {
          mask: '+{1}(000)000-0000'
        });
      } catch (e) {}
    }
  ...
  _createClass(MainSlider, [{
    ...
    value: function showSlides(n) {
      ...
      try {
        ...
        if (n === 3) {
          setTimeout(function () {
            _this.blockShow.style.display = 'block';

            _this.blockShow.classList.add('animate__animated', 'animate__slideInUp');
          }, 3000);
        } else {
          this.blockShow.style.display = 'none';
    ...
    key: "btnNavModule",
    value: function btnNavModule(selector, num) {
      var _this2 = this;
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      prevMod = _ref.prevMod,
      nextMod = _ref.nextMod;
